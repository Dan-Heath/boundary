...
// TODO (jefferai 10/2022): NewVerifierContextWithAccounts calls
// NewVerifierContext but with a function that can be used to look up account
// information. This is not intended to be a long-lived function; see
